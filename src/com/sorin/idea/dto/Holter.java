...
public class Holter implements Serializable
{
	/** 
	 * This attribute maps to the column IDHOLTER in the holter table.
	 */
	protected Integer idholter;

	/** 
	 * This attribute maps to the column FECHACOLOCACION in the holter table.
	 */
	protected Date fechacolocacion;

	/** 
	 * This attribute maps to the column FECHALECTURA in the holter table.
	 */
	protected Date fechalectura;

	/** 
	 * This attribute maps to the column FECHARETIRADA in the holter table.
	 */
	protected Date fecharetirada;

	/** 
	 * This attribute maps to the column FECHANALISIS in the holter table.
	 */
	protected Date fechanalisis;

	/** 
	 * This attribute maps to the column ESTADO in the holter table.
	 */
	protected Integer estado;

	/** 
	 * This attribute maps to the column COMENTARIOS_COL in the holter table.
	 */
	protected String comentariosCol;

	/** 
	 * This attribute maps to the column COMENTARIOS_ANA in the holter table.
	 */
	protected String comentariosAna;

	/** 
	 * This attribute maps to the column RECOMENDACIONES in the holter table.
	 */
	protected String recomendaciones;

	/** 
	 * This attribute maps to the column DIAGNOSTICOINI in the holter table.
	 */
	protected Integer diagnosticoini;

	/** 
	 * This attribute maps to the column DIAGNOSTICOFIN in the holter table.
	 */
	protected Integer diagnosticofin;

	/** 
	 * This attribute maps to the column REFERIDOR in the holter table.
	 */
	protected String referidor;

	/** 
	 * This attribute maps to the column COLOCACION_ENF in the holter table.
	 */
	protected String colocacionEnf;

	/** 
	 * This attribute maps to the column COLOCACION_MED in the holter table.
	 */
	protected String colocacionMed;

	/** 
	 * This attribute maps to the column ANALISIS_MED in the holter table.
	 */
	protected String analisisMed;

	/** 
	 * This attribute maps to the column RETIRADA_ENF in the holter table.
	 */
	protected String retiradaEnf;

	/** 
	 * This attribute maps to the column RETIRADA_MED in the holter table.
	 */
	protected String retiradaMed;

	/** 
	 * This attribute maps to the column NPROC in the holter table.
	 */
	protected String nproc;

	/** 
	 * This attribute maps to the column DIAGINIOTRO in the holter table.
	 */
	protected String diaginiotro;

	/** 
	 * This attribute maps to the column DIAGFINOTRO in the holter table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Holter)) {
			return false;
		}
		
		final Holter _cast = (Holter) _other;
	 ...
	 * @return HolterPk
	 */
	public HolterPk createPk()
	{
		return new HolterPk(idholter);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.sorin.idea.dto.Holter: " );
