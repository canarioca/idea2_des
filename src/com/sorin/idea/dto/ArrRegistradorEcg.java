...
public class ArrRegistradorEcg implements Serializable
{
	/** 
	 * This attribute maps to the column ID_REGISTRADOR in the arr_registrador_ecg table.
	 */
	protected Integer idRegistrador;

	/** 
	 * This attribute maps to the column IDRITMO in the arr_registrador_ecg table.
	 */
	protected Integer idritmo;

	/** 
	 * This attribute maps to the column IDCONDUCCION in the arr_registrador_ecg table.
	 */
	protected Integer idconduccion;

	/** 
	 * This attribute maps to the column IDCONDUCCIONNO in the arr_registrador_ecg table.
	 */
	protected Integer idconduccionno;

	/** 
	 * This attribute maps to the column IDQRS in the arr_registrador_ecg table.
	 */
	protected Integer idqrs;

	/** 
	 * This attribute maps to the column IDQRSNO in the arr_registrador_ecg table.
	 */
	protected Integer idqrsno;

	/** 
	 * This attribute maps to the column MORFOLOGIA in the arr_registrador_ecg table.
	 */
	protected String morfologia;

	/** 
	 * This attribute maps to the column COMENTARIOS in the arr_registrador_ecg table.
	 */
	protected String comentarios;

	/** 
	 * This attribute maps to the column RR in the arr_registrador_ecg table.
	 */
	protected String rr;

	/** 
	 * This attribute maps to the column PR in the arr_registrador_ecg table.
	 */
	protected String pr;

	/** 
	 * This attribute maps to the column QRS in the arr_registrador_ecg table.
	 */
	protected String qrs;

	/** 
	 * This attribute maps to the column QT in the arr_registrador_ecg table.
	 */
	protected String qt;

	/** 
	 * This attribute maps to the column QTC in the arr_registrador_ecg table.
	 */
	protected String qtc;

	/**
	 * Method 'ArrRegistradorEcg'
	 * 
	 */
	public ArrRegistradorEcg()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ArrRegistradorEcg)) {
			return false;
		}
		
		final ArrRegistradorEcg _cast = (ArrRegistradorEcg) _other;
	 ...
	 * Method 'createPk'
	 * 
	 * @return ArrRegistradorEcgPk
	 */
	public ArrRegistradorEcgPk createPk()
	{
		return new ArrRegistradorEcgPk(idRegistrador);
	}
	...
	public String toString()
	{
		...
		ret.append( "hvn.apl.jProyecto2011.dto.ArrRegistradorEcg: " );
