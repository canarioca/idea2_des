...
public class ReportePacienteConsentimiento {

	private static Logger logger = Logger.getLogger(ReportePacienteConsentimiento.class);
	...
	public ReportePacienteConsentimiento(String path, PacienteAplDto pacienteSelect, InfoCentro infocentro,ConsentimientoBean cons, ResourceBundle bundle){
	...
	public void GeneraArchivoPlanilla(){
		Element root = new Element("CONSENTIMIENTO");
		...
		try{
			...
			e.printStackTrace();
			logger.error("Error generando fichero XML para informe - Reporte Consentimiento Paciente. Motivo: "+e.getMessage(),e);
		}
