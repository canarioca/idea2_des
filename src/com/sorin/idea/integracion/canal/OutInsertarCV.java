 ...
 */
            ...
            /**
            *  OutInsertarCV bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OutInsertarCV
    ...
    public static class Factory{
        ...
        */
        public static OutInsertarCV parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OutInsertarCV object =
                new OutInsertarCV();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"outInsertarCV".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OutInsertarCV)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
