 ...
 */
            ...
            /**
            *  InInsertarRegistrador bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InInsertarRegistrador
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://canal.integracion.idea.sorin.com",
                "inInsertarRegistrador",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Registrador
                        */

                        
                                    protected com.sorin.idea.integracion.canal.Registrador localRegistrador ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRegistradorTracker = false ;

                           public boolean isRegistradorSpecified(){
                               return localRegistradorTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.sorin.idea.integracion.canal.Registrador
                           */
                           public  com.sorin.idea.integracion.canal.Registrador getRegistrador(){
                               return localRegistrador;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Registrador
                               */
                               public void setRegistrador(com.sorin.idea.integracion.canal.Registrador param){
                            localRegistradorTracker = param != null;
                                   
                                            this.localRegistrador=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":inInsertarRegistrador",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "inInsertarRegistrador",
                           xmlWriter);
                              ...
                              if (localSituacionclinicaTracker){
                                           ...
                                           localEcg.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","ecg"),
                                               xmlWriter);
                                        } if (localRegistradorTracker){
                                            if (localRegistrador==null){
                                                 throw new org.apache.axis2.databinding.ADBException("registrador cannot be null!!");
                                            }
                                           localRegistrador.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","registrador"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com",
                                    ...
                                    elementList.add(localRegistrador);
                                }
    ...
    public static class Factory{
        ...
        */
        public static InInsertarRegistrador parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InInsertarRegistrador object =
                new InInsertarRegistrador();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"inInsertarRegistrador".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InInsertarRegistrador)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","registrador").equals(reader.getName())){
                                
                                                object.setRegistrador(com.sorin.idea.integracion.canal.Registrador.Factory.parse(reader));
