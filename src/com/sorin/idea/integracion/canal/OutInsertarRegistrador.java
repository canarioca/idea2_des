 ...
 */
            ...
            /**
            *  OutInsertarRegistrador bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OutInsertarRegistrador
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://canal.integracion.idea.sorin.com",
                "outInsertarRegistrador",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":outInsertarRegistrador",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "outInsertarRegistrador",
    ...
    public static class Factory{
        ...
        */
        public static OutInsertarRegistrador parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OutInsertarRegistrador object =
                new OutInsertarRegistrador();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"outInsertarRegistrador".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OutInsertarRegistrador)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
