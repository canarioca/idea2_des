 ...
 */
            ...
            /**
            *  PruebasFarmaEF bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PruebasFarmaEF
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PruebasFarmaEF",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PruebasFarmaEF",
    ...
    public static class Factory{
        ...
        */
        public static PruebasFarmaEF parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PruebasFarmaEF object =
                new PruebasFarmaEF();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PruebasFarmaEF".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PruebasFarmaEF)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
