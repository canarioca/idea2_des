 ...
 */
            ...
            /**
            *  InInsertarTestATP bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InInsertarTestATP
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected com.sorin.idea.integracion.canal.TestATP localAtp ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAtpTracker = false ;

                           public boolean isAtpSpecified(){
                               return localAtpTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.sorin.idea.integracion.canal.TestATP
                           */
                           public  com.sorin.idea.integracion.canal.TestATP getAtp(){
                               return localAtp;
                           }
                            ...
                            /**
                               ...
                               * @param param Atp
                               */
                               public void setAtp(com.sorin.idea.integracion.canal.TestATP param){
                            localAtpTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":inInsertarTestATP",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "inInsertarTestATP",
                           xmlWriter);
                              ...
                              if (localSituacionclinicaTracker){
                                           ...
                                           localEcg.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","ecg"),
                                            ...
                                            if (localAtp==null){
                                                 throw new org.apache.axis2.databinding.ADBException("atp cannot be null!!");
                                            }
                                           localAtp.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","atp"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static InInsertarTestATP parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InInsertarTestATP object =
                new InInsertarTestATP();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"inInsertarTestATP".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InInsertarTestATP)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","atp").equals(reader.getName())){
                                
                                                object.setAtp(com.sorin.idea.integracion.canal.TestATP.Factory.parse(reader));
