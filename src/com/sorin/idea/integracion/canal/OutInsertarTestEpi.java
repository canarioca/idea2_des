 ...
 */
            ...
            /**
            *  OutInsertarTestEpi bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OutInsertarTestEpi
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":outInsertarTestEpi",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "outInsertarTestEpi",
    ...
    public static class Factory{
        ...
        */
        public static OutInsertarTestEpi parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OutInsertarTestEpi object =
                new OutInsertarTestEpi();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"outInsertarTestEpi".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OutInsertarTestEpi)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
