			...
			<h:panelGrid cellpadding="0" cellspacing="0" columns="1" width="98%"
				...
				<rich:panel>
					...
					<rich:tabPanel switchType="client" width="100%" height="500px">
						...
						<rich:tab label="#{ms.est_basic_tab_imp_title }" rendered="#{controlPacientes.booleanPrimoImplante == true or 
						...
						<rich:tab label="#{ms.est_basic_tab_regev_title }" rendered="#{controlPacientes.booleanRegistradorEventos == true}">
						...
						<rich:tab label="#{ms.est_basic_tab_elr_title }" rendered="#{controlPacientes.booleanRegistradorEventosExterno == true}">
