						...
						<t:dataTable width="100%" rows="10"
							...
							<t:column width="15%" style="text-align: left;" rendered="#{loginForm.acceso.idrolacceso ne 3 }"
								...
								<h:panelGrid style="text-align:left;"  id="hpanprocs" columns="3"
									...
									<a4j:commandLink id="linkRehabilitacionCardiaca" rendered="#{controlPacientes.filtro.tipoproc eq 14 }"
										actionListener="#{controlPacientes.obtenLineaRehabilitacionCardiaca}"
										onclick="javascript:Richfaces.showModalPanel('buscando');"
										title="#{ms.ver_registro }" action="irRehabilitacionCardiaca">
										<h:graphicImage value="/img/iconos/bpm.png" style="border: 0px;"
											width="22" height="22"/>
										<h:outputLabel value="#{linea.nRehabilitacionCardiaca}" />
									</a4j:commandLink>
								</h:panelGrid>
							</t:column>
							<t:column width="15%" style="text-align: left;" rendered="#{loginForm.acceso.idrolacceso ne 3 }"
								...
								<h:panelGrid style="text-align:left;"  id="hpanprocsfechas" columns="3"
									...
									<a4j:commandLink id="linkprocsfechaRehabilitacionCardiaca" rendered="#{linea.fechaRehabilitacionCardiaca ne null }" 
										actionListener="#{controlPacientes.obtenLineaRehabilitacionCardiaca}" 
										onclick="javascript:Richfaces.showModalPanel('buscando');" 
										title="#{ms.ver_registro }" action="irRehabilitacionCardiaca">										
										<h:outputLabel value="#{linea.fechaRehabilitacionCardiaca}">
											<f:convertDateTime pattern="dd.MM.yyyy" timeZone="GMT+2"/>
										</h:outputLabel>
									</a4j:commandLink>
								</h:panelGrid>
