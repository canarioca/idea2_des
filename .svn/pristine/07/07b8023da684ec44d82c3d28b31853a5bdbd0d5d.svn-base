	...
	<h:panelGrid>
		...
		<h:panelGrid width="90%" columns="6" columnClasses="left,left">
			...
			<h:panelGrid>
				...
				<h:panelGrid style="border-top: solid 1px;border-color: black;">
					<h:selectOneMenu onclick="showOnMap(this)" style="width:200px;"  layout="spread" id="idSelectedPlantilla" value="#{controlHolter.selectedPlantilla}">
		 				 <f:selectItems value="#{controlHolter.listaPlantillas}" />
		 				 <a4j:support event="onchange" ajaxSingle="false" reRender="comentariosHolterRec" actionListener="#{controlHolter.cambiarPlantilla}" />
					</h:selectOneMenu>   
				</h:panelGrid>
			</h:panelGrid>
		</h:panelGrid>
		...
		<h:panelGrid>
			...
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlHolter.holter.comentariosAna}" rows="4" cols="90" id="comentariosHolterRec">
		...
		<h:panelGrid>
			...
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlHolter.holter.recomendaciones}" rows="4" cols="90" id="comentariosHolterRet">
					<f:validateLength maximum="2000" />
				</h:inputTextarea>
