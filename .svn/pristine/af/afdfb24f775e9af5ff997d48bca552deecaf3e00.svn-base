...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="tablaPacientesBduPrt" width="100%">
		<h:outputText rendered="#{empty controlMesas.listaprot}"
		...
		<t:dataTable styleClass="hor-minimalist-b" var="prot" width="90%"
			binding="#{controlMesas.bindingProt}" id="tablaprotocolospat" rows="13"
			preserveDataModel="true" value="#{controlMesas.listaprot}">
			<t:column id="vinculoPrt">
				<f:facet name="header">
					<h:outputText value="" />
				</f:facet>
				<a4j:commandLink reRender="panMesa,panicomesa"
					actionListener="#{controlMesas.vincularProtocolo}"
			...
			<t:column id="fechaIniPrt">
				...
				<a4j:commandLink value="#{prot.fechacreacion}" reRender="panMesa,panicomesa"
					actionListener="#{controlMesas.vincularProtocolo}"
					onclick="javascript:Richfaces.showModalPanel('buscando');javascript:Richfaces.hideModalPanel('protocolos');"
					oncomplete="javascript:Richfaces.hideModalPanel('buscando');" />
			</t:column>
			<t:column id="tipoPrt">
				...
				<h:selectOneMenu value="#{prot.tipo }" disabled="true">
					<f:selectItems value="#{controlMesas.tipos}" />							
				</h:selectOneMenu>
			</t:column>
			<t:column id="verPrt">
				<f:facet name="header">
				...
				<a4j:commandLink actionListener="#{controlMesas.irProtocolo}"
