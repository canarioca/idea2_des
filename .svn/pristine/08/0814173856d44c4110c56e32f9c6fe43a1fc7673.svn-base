...
/**
 * InInsertarSeguimientoRegistrador.java
 *
 ...
 */
            ...
            /**
            *  InInsertarSeguimientoRegistrador bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InInsertarSeguimientoRegistrador
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://canal.integracion.idea.sorin.com",
                "inInsertarSeguimientoRegistrador",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Seguimiento
                        */

                        
                                    protected com.sorin.idea.integracion.canal.SeguimientoRegistrador localSeguimiento ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSeguimientoTracker = false ;

                           public boolean isSeguimientoSpecified(){
                               return localSeguimientoTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.sorin.idea.integracion.canal.SeguimientoRegistrador
                           */
                           public  com.sorin.idea.integracion.canal.SeguimientoRegistrador getSeguimiento(){
                               return localSeguimiento;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Seguimiento
                               */
                               public void setSeguimiento(com.sorin.idea.integracion.canal.SeguimientoRegistrador param){
                            localSeguimientoTracker = param != null;
                                   
                                            this.localSeguimiento=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":inInsertarSeguimientoRegistrador",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "inInsertarSeguimientoRegistrador",
                           xmlWriter);
                              ...
                              if (localSituacionclinicaTracker){
                                           ...
                                           localSituacionclinica.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","situacionclinica"),
                                               xmlWriter);
                                        } if (localSeguimientoTracker){
                                            if (localSeguimiento==null){
                                                 throw new org.apache.axis2.databinding.ADBException("seguimiento cannot be null!!");
                                            }
                                           localSeguimiento.serialize(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","seguimiento"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com",
                                    ...
                                    elementList.add(localSeguimiento);
                                }
    ...
    public static class Factory{
        ...
        */
        public static InInsertarSeguimientoRegistrador parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InInsertarSeguimientoRegistrador object =
                new InInsertarSeguimientoRegistrador();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"inInsertarSeguimientoRegistrador".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InInsertarSeguimientoRegistrador)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://canal.integracion.idea.sorin.com","seguimiento").equals(reader.getName())){
                                
                                                object.setSeguimiento(com.sorin.idea.integracion.canal.SeguimientoRegistrador.Factory.parse(reader));
