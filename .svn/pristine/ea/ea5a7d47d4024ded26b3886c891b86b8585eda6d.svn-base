...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panNuevoItemPlanGenImp" >
		<h:panelGrid columns="3" width="100%" columnClasses="alignTop,alignTop,alignTop" id="panMedNuevoItemPlanGenImp">
			<h:panelGrid>
			...
			<h:panelGrid rendered="false" id="panNuevoItemPlanGenImpCom">
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.planmedgen.idmedcom }"
						...
						<a4j:support event="onchange" reRender="panNuevoItemPlanGenImp" ajaxSingle="true" />						
					</h:selectOneMenu>
					<h:selectOneMenu value="#{controlMedicacion.planmedgen.idmedcom }"
						rendered="#{controlMedicacion.planmedgen.medicacionDto.medgenerico.tipomed eq 10}">
		...
		<rich:simpleTogglePanel switchType="client" label="Posología" opened="false" rendered="false">
