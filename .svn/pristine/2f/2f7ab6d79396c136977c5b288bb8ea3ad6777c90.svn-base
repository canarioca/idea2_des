...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="tablaPacientesBduPrt" width="100%">
		<h:outputText rendered="#{empty controlTestOrtostatismo.listaprot}"
		...
		<t:dataTable styleClass="hor-minimalist-b" var="prot" width="90%"
			binding="#{controlTestOrtostatismo.bindingProt}" id="tablaprotocolospat" rows="13"
			preserveDataModel="true" value="#{controlTestOrtostatismo.listaprot}">
			<t:column id="vinculoPrt">
				<f:facet name="header">
					<h:outputText value="" />
				</f:facet>
				<a4j:commandLink reRender="panTestOrto,panicotestorto"
					actionListener="#{controlTestOrtostatismo.vincularProtocolo}"
			...
			<t:column id="fechaIniPrt">
				...
				<a4j:commandLink value="#{prot.fechacreacion}" reRender="panTestOrto,panicotestorto"
					actionListener="#{controlTestOrtostatismo.vincularProtocolo}"
					onclick="javascript:Richfaces.showModalPanel('buscando');javascript:Richfaces.hideModalPanel('protocolos');"
					oncomplete="javascript:Richfaces.hideModalPanel('buscando');" />
			</t:column>
			<t:column id="tipoPrt">
				...
				<h:selectOneMenu value="#{prot.tipo }" disabled="true">
					<f:selectItems value="#{controlTestOrtostatismo.tipos}" />							
				</h:selectOneMenu>
			</t:column>
			<t:column id="verPrt">
				<f:facet name="header">
				...
				<a4j:commandLink actionListener="#{controlTestOrtostatismo.irProtocolo}"
