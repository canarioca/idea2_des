...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panEditItemComplicacionesPacImpEv" >
		<h:panelGrid id="panEditComplicacionPacImpEv" width="100%" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacCompliImpEv">
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.complicacion }">
					<f:selectItems value="#{controlComplicaciones.complicacionesImpl }" />
					<a4j:support event="onchange" reRender="panEditComPacCompliImpEv" ajaxSingle="true" />						
				</h:selectOneMenu>
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.complicacion1 }" 
					rendered="#{controlImplantes.currentItemCompPost.complicacion eq  controlComplicaciones.idarritmias}">
				...
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.complicacion1 }" 
					rendered="#{controlImplantes.currentItemCompPost.complicacion eq controlComplicaciones.idhematoma}">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
				...
				<h:inputText value="#{controlImplantes.currentItemCompPost.complicacionOtra }" 
					rendered="#{controlImplantes.currentItemCompPost.complicacion eq controlComplicaciones.idcompotra}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.tipo }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					...
					value="#{controlImplantes.currentItemCompPost.fechaini }" />
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					showWeeksBar="false" direction="bottom-left" 
					value="#{controlImplantes.currentItemCompPost.fechafin }" />
			</h:panelGrid>
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.resuelta }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacTratImpEv">								
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.tratamiento }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
					<f:selectItem itemValue="0" itemLabel="#{ms.compli_tratamiento_0 }"/>
					<f:selectItem itemValue="1" itemLabel="#{ms.compli_tratamiento_1 }"/>
					<a4j:support event="onchange" reRender="panEditComPacTratImpEv" ajaxSingle="true" />
				</h:selectOneMenu>
				<h:inputText value="#{controlImplantes.currentItemCompPost.tratamientoDescr }" 
					rendered="#{controlImplantes.currentItemCompPost.tratamiento eq 1}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemCompPost.ingreso }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea cols="40" rows="4" value="#{controlImplantes.currentItemCompPost.descripcion }" id="descEditComPacImpEv">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="descEditComPacImpEv" style="color:red" />
			</h:panelGrid>
		</h:panelGrid>
	</h:panelGrid>
</ui:composition>