...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panEditItemPlanGen" >
		<h:panelGrid columns="3" width="100%" columnClasses="alignTop,alignTop,alignTop" id="panMedEditItemPlanGen">
			<h:panelGrid>
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
					<r:comboBox enableManualInput="true" defaultLabel="#{ms.med_gen_msg_27 }" width="220"
						rendered="false"
						value="#{controlMedicacion.currentItem.medicacionDto.medgenerico.codigo}">
						<f:selectItems value="#{controlMedicacion.genericos }"/>
						<a4j:support event="onchange" reRender="panMedEditItemPlanGen" ajaxSingle="true"
					...
					<h:selectOneMenu value="#{controlMedicacion.currentItem.medicacionDto.medgenerico.tipomed }">
						...
						<a4j:support event="onchange" reRender="panEditMedGenComponentes" ajaxSingle="true"/>						
					</h:selectOneMenu>
				</h:panelGrid>
				<h:panelGrid>
					<h:panelGrid columnClasses="alignTop" id="panEditMedGenComponentes">								
			...
			<h:panelGrid rendered="false" id="panEditItemPlanGenCom">
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.currentItem.idmedcom }"
						...
						<a4j:support event="onchange" reRender="panEditItemPlanGen" ajaxSingle="true" />						
					</h:selectOneMenu>
					<h:selectOneMenu value="#{controlMedicacion.currentItem.idmedcom }"
		...
		<h:panelGrid id="panEditFechasItemPlanMedGen" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
			<h:panelGrid>
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.currentItem.estado }">
						...
						<a4j:support event="onchange" reRender="panEditMotivosSuspItemPlanGen" ajaxSingle="true"/>														
					</h:selectOneMenu>
				</h:panelGrid>
			</h:panelGrid>
			<h:panelGrid>
		...
		<h:panelGrid id="panEditMotivosSuspItemPlanGen">
			...
			<h:panelGrid style="border-top: solid 1px;border-color: black;" rendered="#{controlMedicacion.currentItem.estado eq 0 }">
				<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.currentItem.motivosuspension }" id="motivosEditSuspItemPlanGen">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="motivosEditSuspItemPlanGen" style="color:red" />
			</h:panelGrid>
		</h:panelGrid>
		<rich:simpleTogglePanel switchType="client" label="#{ms.med_gen_msg_25 }" opened="false">
			<h:panelGrid>
				<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.currentItem.comentarios }" id="comentariosEditItemPlanGen">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="comentariosEditItemPlanGen" style="color:red" />
			</h:panelGrid>
		</rich:simpleTogglePanel>
	</h:panelGrid>
</ui:composition>