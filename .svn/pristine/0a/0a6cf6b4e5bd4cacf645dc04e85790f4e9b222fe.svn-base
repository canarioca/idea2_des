...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<rich:panel header="#{ms.menu_pr_title }" styleClass="fondo_trans" style="margin-top: 15px;"
		id="menu">
		...
		<rich:panelMenu mode="ajax" iconExpandedGroup="disc" 
			...
			<rich:panelMenuGroup label="#{ms.pacientes }" expanded="true">
				...
				<rich:panelMenuItem label="#{ms.menu_pr_msg_le_1 }" action="irLE" rendered="#{loginForm.accmods.lespera eq 1 }"
			...
			<rich:panelMenuGroup label="#{ms.menu_pr_msg_diag_1 }" expanded="false" styleClass="diagnostico"
				rendered="#{(loginForm.accmods.test eq 1 || loginForm.accmods.mesa eq 1 || loginForm.accmods.registrador eq 1 || loginForm.accmods.holter eq 1) and loginForm.acceso.idrolacceso ne 3}">
				...
				<rich:panelMenuGroup label="#{ms.menu_pr_msg_test_orto_1 }" expanded="#{loginForm.nodos[6] }"
					...
					rendered="#{loginForm.accmods.testOrto eq 1}" styleClass="diagnostico">
				...
				<rich:panelMenuGroup label="#{ms.menu_pr_msg_mesa_1 }"  expanded="#{loginForm.nodos[6] }"
					disabled="#{controlPacientes.modPaci eq 0 }"
					rendered="#{loginForm.accmods.mesa eq 1 and true}" styleClass="diagnostico">
				...
				<rich:panelMenuGroup label="#{ms.menu_pr_msg_holter_1 }"  expanded="#{loginForm.nodos[7] }"
					disabled="#{controlPacientes.modPaci eq 0 }"
					rendered="#{loginForm.accmods.holter eq 1 and true}" styleClass="diagnostico">
				...
				<rich:panelMenuGroup label="#{ms.menu_pr_msg_elr_1 }"  expanded="#{loginForm.nodos[7] }"
					disabled="#{controlPacientes.modPaci eq 0 }"
					rendered="#{loginForm.accmods.elr eq 1 and true}" styleClass="diagnostico">
				...
				<rich:panelMenuGroup label="#{ms.menu_pr_msg_ilr_1 }"  expanded="#{loginForm.nodos[7] }"
					disabled="#{controlPacientes.modPaci eq 0 }"
					rendered="#{loginForm.accmods.registrador eq 1 and true}" styleClass="diagnostico">
			...
			<rich:panelMenuGroup label="#{ms.menu_pr_msg_eef_1 }" expanded="false" styleClass="eefabl" rendered="#{loginForm.accmods.eef eq 1 and loginForm.acceso.idrolacceso ne 3}">
			...
			<rich:panelMenuGroup label="#{ms.menu_pr_msg_trat }" expanded="false" styleClass="tratamiento" 
				rendered="#{(loginForm.accmods.cv eq 1 or loginForm.accmods.implante eq 1) and loginForm.acceso.idrolacceso ne 3 }">
			...
			<rich:panelMenuGroup label="#{ms.menu_pr_msg_prot }" expanded="false" styleClass="protocolos" 
				rendered="#{loginForm.accmods.protocolos eq 1 and loginForm.acceso.idrolacceso ne 3 }" disabled="#{controlPacientes.modPaci eq 0 }">
			...
			<rich:panelMenuGroup label="#{ms.menu_pr_msg_gestion_datos_1 }" expanded="#{loginForm.nodos[4] }" rendered="#{loginForm.acceso.idrolacceso eq 1 }"
				...
				<rich:panelMenuItem label="#{ms.menu_pr_msg_gestion_datos_8 }" action="irRecalls"
						icon="/img/iconos/alerta.png" rendered="#{loginForm.accmods.implante eq 1 or loginForm.accmods.registrador eq 1}"
						actionListener="#{controlRecalls.inicia }"/>
				<rich:panelMenuItem label="#{ms.menu_pr_msg_gestion_datos_5 }" action="irAnual"
						icon="/img/iconos/formularios.jpg" rendered="#{loginForm.accmods.eef eq 1 and true}"
				...
				<rich:panelMenuItem label="#{ms.menu_pr_msg_gestion_datos_6 }" action="irExportacion"
						icon="/img/iconos/xml.png" rendered="#{loginForm.accmods.implante eq 1 and true}"
