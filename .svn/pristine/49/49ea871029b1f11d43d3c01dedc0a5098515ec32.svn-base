...
public class PacienteAplDto extends BaseDto {
    ...
    private String            nRehabilitacionCardiaca="";
    ...
    private Integer			  idRehabilitacionCardiaca = 0;
    ...
    private Date 		      fechaRehabilitacionCardiaca;
	...
	public String getnRehabilitacionCardiaca() {
		return nRehabilitacionCardiaca;
	}

	public void setnRehabilitacionCardiaca(String nRehabilitacionCardiaca) {
		this.nRehabilitacionCardiaca = nRehabilitacionCardiaca;
	}

	public Integer getIdRehabilitacionCardiaca() {
		return idRehabilitacionCardiaca;
	}

	public void setIdRehabilitacionCardiaca(Integer idRehabilitacionCardiaca) {
		this.idRehabilitacionCardiaca = idRehabilitacionCardiaca;
	}

	public Date getFechaRehabilitacionCardiaca() {
		return fechaRehabilitacionCardiaca;
	}

	public void setFechaRehabilitacionCardiaca(Date fechaRehabilitacionCardiaca) {
		this.fechaRehabilitacionCardiaca = fechaRehabilitacionCardiaca;
	}
