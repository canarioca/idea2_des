...
*/
		...
		if (this.eef.getAblacion() == 2) {
			if(this.eef.getAblaciondto().getSustrato()!=null && this.eef.getAblaciondto().getSustrato()>0
				...
				if (this.eef.getAblaciondto().getIdablacion() == null) {
					...
					this.eef.getAblaciondto().getComplicacion().setIdestudio(ablpk.getIdestudio());
					...
					/*if(this.eef.getResultados().size() < this.eef.getAblaciones().size())
						this.eef.getResultados().add(this.eef.getResultadodto());
	...
	public void addAplicacion(ActionEvent e){
		//this.eef.getAblaciondto().getListapls().add(new ArrEstudioCatApl());
	...
	public void delAbordaje(ActionEvent e){
		//System.out.println(this.eef.getAblaciondto().getBindingApls().getRowIndex());
	...
	public void cambiaModeloCateterAblacionAplicacion(ActionEvent e){
		//System.out.println(this.eef.getAblaciondto().getBindingApls().getRowIndex());
		//System.out.println(this.eef.getAblaciondto().getBindingAbordajes().getRowIndex());
		...
		for(ArrEstudioCatUso c:this.eef.getListacats()){
			if(c.getModelo().equals(modelo)){
				...
				controlAplicacion(null);
				//System.out.println("CAMBIA MODELO OK. "+c.getIdcatuso());
				break;		
			}		
		}	
	}
