...
public class ArrTestAtpEcgDaoImpl extends AbstractDAO implements ArrTestAtpEcgDao
{
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	public ArrTestAtpEcgPk insert(ArrTestAtpEcg dto) throws ArrTestAtpEcgDaoException
	{
		...
		try {
			...
			throw new ArrTestAtpEcgDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		ArrTestAtpEcg ret[] = findByDynamicSelect( SQL_SELECT + " WHERE IDTEST = ?", new Object[] { idtest } );
	...
	/**
	 * Method 'ArrTestAtpEcgDaoImpl'
	 * 
	 */
	public ArrTestAtpEcgDaoImpl()
	{
	}
	public ArrTestAtpEcgDaoImpl(String usuario)
	{
		this.auditoriaDto = new AuditoriaDto(usuario, getTableName());
	}
	public ArrTestAtpEcgDaoImpl(final java.sql.Connection userConn,String usuario)
	{
	 ...
	 * @param userConn
	 */
	public ArrTestAtpEcgDaoImpl(final java.sql.Connection userConn)
	{
		this.userConn = userConn;
	}
	 ...
	 */
	protected ArrTestAtpEcg fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			ArrTestAtpEcg dto = new ArrTestAtpEcg();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected ArrTestAtpEcg[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		ArrTestAtpEcg ret[] = new ArrTestAtpEcg[ resultList.size() ];
	 ...
	 */
	protected void populateDto(ArrTestAtpEcg dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(ArrTestAtpEcg dto)
	{
	}
