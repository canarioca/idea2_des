...
public class ControlComplicaciones extends BaseIU{
	...
	public void obtenerProcedimientosPaciente(ActionEvent e){
		try{
			...
			for(Procedimiento p:procs){
				List<ArrAccesoModulos> listaModuloss = Arrays.asList( this.lf.getAccmods() );
				
				for( ArrAccesoModulos arrAccesoModulos :  listaModuloss ) {
					
					if( arrAccesoModulos.getIdTipoProcedimiento() == 1061 && p.getTipoprocedimiento().equals(1061))
						this.listaprocsdisp.add(p); 
					else if( (   arrAccesoModulos.getIdTipoProcedimiento() == 993  || 
							arrAccesoModulos.getIdTipoProcedimiento() == 956  || 
							arrAccesoModulos.getIdTipoProcedimiento() == 957  || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1059 || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1060 || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1090 || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1085 || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1086 || 
							arrAccesoModulos.getIdTipoProcedimiento() == 1147 ||
							arrAccesoModulos.getIdTipoProcedimiento() == 983 )
							&& (p.getTipoprocedimiento().equals(993) || 
								p.getTipoprocedimiento().equals(956) || 
								p.getTipoprocedimiento().equals(957) || 
								p.getTipoprocedimiento().equals(1059) || 
								p.getTipoprocedimiento().equals(1060) || 
								p.getTipoprocedimiento().equals(1090) || 
								p.getTipoprocedimiento().equals(1085) || 
								p.getTipoprocedimiento().equals(1086) || 
								p.getTipoprocedimiento().equals(1147) || 
								p.getTipoprocedimiento().equals(983)))
						this.listaprocsdisp.add(p);
					else if(arrAccesoModulos.getIdTipoProcedimiento() == 1068  && p.getTipoprocedimiento().equals(1068))
						this.listaprocsdisp.add(p);
					else if( ( arrAccesoModulos.getIdTipoProcedimiento() == 1067 || 
						  arrAccesoModulos.getIdTipoProcedimiento() == 1088 ) && 
						( p.getTipoprocedimiento().equals(1067) || 
						  p.getTipoprocedimiento().equals(1088) ) ) {
						this.listaprocsdisp.add(p);
					}
	...
	public ArrayList<SelectItem> getModulosDisponibles(){
		...
		for( ArrAccesoModulos arrAccesoModulos : listaModulos ) {
			...
			else if( arrAccesoModulos.getIdTipoProcedimiento() == 983 ){
				mods.add(new SelectItem(3, "Seguimiento de dispositivo"));
			}
			else if( arrAccesoModulos.getIdTipoProcedimiento() == 1067 ){
				mods.add(new SelectItem(4, "Registrador de eventos"));
			}
			else if ( arrAccesoModulos.getIdTipoProcedimiento() == 1088  ) {
		...
		for (Complicaciones c : this.complicaciones){
			...
			for( ArrAccesoModulos arrAccesoModulos : listaModulos ) {
				...
				if(   c.getAmbito().equals(3) && 
					( arrAccesoModulos.getIdTipoProcedimiento() == 956 || 
					  arrAccesoModulos.getIdTipoProcedimiento() == 1067 )) {
							compl.add(new SelectItem(c.getIdcomplicacion(), c.getNombre()));
						}
				else if( ( c.getAmbito().equals(1) || c.getAmbito().equals(2) ) 
						&& arrAccesoModulos.getIdTipoProcedimiento() == 1061 ) {
					compl.add(new SelectItem(c.getIdcomplicacion(), c.getNombre()));
				}
				else if ( c.getAmbito().equals(5) && 
						( arrAccesoModulos.getIdTipoProcedimiento() == 1068 )) {
					compl.add(new SelectItem(c.getIdcomplicacion(), c.getNombre()));
				}
				if(c.getAmbito().equals(0)) {
					compl.add(new SelectItem(c.getIdcomplicacion(), c.getNombre()));
