...
public class ControlPacientes extends BaseIU {
    ...
    private boolean booleanCardioversiónElectrica = false  ;
    ...
    private boolean booleanSeguimientoClínico= false ;
	...
	private boolean accesoModulos(Integer i){
		switch(i){
			...
			case 1068: return this.booleanCardioversiónElectrica  = true ;
			...
			case 1087: return this.booleanSeguimientoClínico = true ;
	...
	public boolean isBooleanCardioversiónElectrica() {
		return booleanCardioversiónElectrica;
	}

	public void setBooleanCardioversiónElectrica(boolean booleanCardioversiónElectrica) {
		this.booleanCardioversiónElectrica = booleanCardioversiónElectrica;
	}
	...
	public boolean isBooleanSeguimientoClínico() {
		return booleanSeguimientoClínico;
	}

	public void setBooleanSeguimientoClínico(boolean booleanSeguimientoClínico) {
		this.booleanSeguimientoClínico = booleanSeguimientoClínico;
	}
