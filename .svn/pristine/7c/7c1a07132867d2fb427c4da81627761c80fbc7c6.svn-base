 ...
 */
            ...
            /**
            *  OutInsertarTestATP bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OutInsertarTestATP
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":outInsertarTestATP",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "outInsertarTestATP",
    ...
    public static class Factory{
        ...
        */
        public static OutInsertarTestATP parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OutInsertarTestATP object =
                new OutInsertarTestATP();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"outInsertarTestATP".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OutInsertarTestATP)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
