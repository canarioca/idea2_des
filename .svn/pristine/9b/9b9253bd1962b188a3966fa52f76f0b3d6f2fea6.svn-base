...
public class SituacionClinicaProc implements Serializable
{
	/** 
	 * This attribute maps to the column IDSITCLIN in the situacion_clinica_proc table.
	 */
	protected Integer idsitclin;

	/** 
	 * This attribute maps to the column RITMO in the situacion_clinica_proc table.
	 */
	protected Integer ritmo;

	/** 
	 * This attribute maps to the column RITMO2 in the situacion_clinica_proc table.
	 */
	protected Integer ritmo2;

	/** 
	 * This attribute maps to the column CONDUCAV in the situacion_clinica_proc table.
	 */
	protected Integer conducav;

	/** 
	 * This attribute maps to the column CONDUCAV2 in the situacion_clinica_proc table.
	 */
	protected Integer conducav2;

	/** 
	 * This attribute maps to the column QRS in the situacion_clinica_proc table.
	 */
	protected Integer qrs;

	/** 
	 * This attribute maps to the column QRS2 in the situacion_clinica_proc table.
	 */
	protected Integer qrs2;

	/** 
	 * This attribute maps to the column ANCHURAQRS in the situacion_clinica_proc table.
	 */
	protected String anchuraqrs;

	/** 
	 * This attribute maps to the column FEVI in the situacion_clinica_proc table.
	 */
	protected String fevi;

	/** 
	 * This attribute maps to the column FUNCIONVENTRICULAR in the situacion_clinica_proc table.
	 */
	protected Integer funcionventricular;

	/** 
	 * This attribute maps to the column NYHA in the situacion_clinica_proc table.
	 */
	protected Integer nyha;

	/** 
	 * This attribute maps to the column CARDIOPATIA in the situacion_clinica_proc table.
	 */
	protected Integer cardiopatia;

	/** 
	 * This attribute maps to the column AEVOLUCION in the situacion_clinica_proc table.
	 */
	protected String aevolucion;

	/** 
	 * This attribute maps to the column OTRA in the situacion_clinica_proc table.
	 */
	protected String otra;

	/** 
	 * This attribute maps to the column REVASC in the situacion_clinica_proc table.
	 */
	protected Short revasc;

	/** 
	 * This attribute maps to the column INFPREVIO in the situacion_clinica_proc table.
	 */
	protected Short infprevio;

	/** 
	 * This attribute maps to the column ANIO in the situacion_clinica_proc table.
	 */
	protected String anio;

	/** 
	 * This attribute maps to the column LOCALIZACION in the situacion_clinica_proc table.
	 */
	protected Integer localizacion;

	/** 
	 * This attribute maps to the column ARRITMIAS in the situacion_clinica_proc table.
	 */
	protected Integer arritmias;

	/** 
	 * This attribute maps to the column EEF in the situacion_clinica_proc table.
	 */
	protected Integer eef;

	/** 
	 * This attribute maps to the column ETIOLOGIA in the situacion_clinica_proc table.
	 */
	protected Integer etiologia;

	/** 
	 * This attribute maps to the column HTA in the situacion_clinica_proc table.
	 */
	protected Short hta;

	/** 
	 * This attribute maps to the column DISLIPEMIA in the situacion_clinica_proc table.
	 */
	protected Short dislipemia;

	/** 
	 * This attribute maps to the column DIABETES in the situacion_clinica_proc table.
	 */
	protected Short diabetes;

	/** 
	 * This attribute maps to the column TABAQUISMO in the situacion_clinica_proc table.
	 */
	protected Short tabaquismo;

	/** 
	 * This attribute maps to the column INGALCOHOLICA in the situacion_clinica_proc table.
	 */
	protected Short ingalcoholica;

	/** 
	 * This attribute maps to the column ACV in the situacion_clinica_proc table.
	 */
	protected Short acv;

	/** 
	 * This attribute maps to the column AIT in the situacion_clinica_proc table.
	 */
	protected Short ait;

	/** 
	 * This attribute maps to the column EPOC in the situacion_clinica_proc table.
	 */
	protected Short epoc;

	/** 
	 * This attribute maps to the column SAHS in the situacion_clinica_proc table.
	 */
	protected Short sahs;

	/** 
	 * This attribute maps to the column TIPOSAHS in the situacion_clinica_proc table.
	 */
	protected Integer tiposahs;

	/** 
	 * This attribute maps to the column AHI in the situacion_clinica_proc table.
	 */
	protected String ahi;

	/** 
	 * This attribute maps to the column CPAP in the situacion_clinica_proc table.
	 */
	protected Short cpap;

	/** 
	 * This attribute maps to the column INSRENAL in the situacion_clinica_proc table.
	 */
	protected Short insrenal;

	/** 
	 * This attribute maps to the column TIPOINSRENAL in the situacion_clinica_proc table.
	 */
	protected Integer tipoinsrenal;

	/** 
	 * This attribute maps to the column NEOPLASIA in the situacion_clinica_proc table.
	 */
	protected Short neoplasia;

	/** 
	 * This attribute maps to the column TIPONEOPLASIA in the situacion_clinica_proc table.
	 */
	protected String tiponeoplasia;

	/** 
	 * This attribute maps to the column AFECTIROIDEA in the situacion_clinica_proc table.
	 */
	protected Integer afectiroidea;

	/** 
	 * This attribute maps to the column ANTFA in the situacion_clinica_proc table.
	 */
	protected Short antfa;

	/** 
	 * This attribute maps to the column HIPERTENSION in the situacion_clinica_proc table.
	 */
	protected Short hipertension;

	/** 
	 * This attribute maps to the column MUERTESUBITA in the situacion_clinica_proc table.
	 */
	protected Short muertesubita;

	/** 
	 * This attribute maps to the column HIPERCOLEST in the situacion_clinica_proc table.
	 */
	protected Short hipercolest;

	/** 
	 * This attribute maps to the column COMENTARIOS in the situacion_clinica_proc table.
	 */
	protected String comentarios;

	/** 
	 * This attribute maps to the column FECHA in the situacion_clinica_proc table.
	 */
	protected Date fecha;

	/** 
	 * This attribute maps to the column NEUROMEDIADOS in the situacion_clinica_proc table.
	 */
	protected Integer neuromediados;

	/** 
	 * This attribute maps to the column TRASPLANTECARDIACO in the situacion_clinica_proc table.
	 */
	protected Short trasplantecardiaco;

	/** 
	 * This attribute maps to the column SINCOPE in the situacion_clinica_proc table.
	 */
	protected Short sincope;

	/** 
	 * This attribute maps to the column PARADACARDIACA in the situacion_clinica_proc table.
	 */
	protected Short paradacardiaca;

	/** 
	 * This attribute maps to the column AI in the situacion_clinica_proc table.
	 */
	protected String ai;

	/** 
	 * This attribute maps to the column AI2 in the situacion_clinica_proc table.
	 */
	protected Integer ai2;

	/** 
	 * This attribute maps to the column ENFART in the situacion_clinica_proc table.
	 */
	...
	/******** IMPLANTES **********/
	protected ArrayList<SintomasSitclinProc> sintomas;
	...
	/**
	 * Method 'SituacionClinicaProc'
	 * 
	 */
	public SituacionClinicaProc()
	{
		this.sintomas = new ArrayList<SintomasSitclinProc>();
	}
	 ...
	 * @param ritmo2
	 */
	public void setRitmo2(Integer ritmo2)
	{
		this.ritmo2 = ritmo2;
	}
	 ...
	 * @param conducav2
	 */
	public void setConducav2(Integer conducav2)
	{
		this.conducav2 = conducav2;
	}
	 ...
	 * @param qrs2
	 */
	public void setQrs2(Integer qrs2)
	{
		this.qrs2 = qrs2;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SituacionClinicaProc)) {
			return false;
		}
		
		final SituacionClinicaProc _cast = (SituacionClinicaProc) _other;
		...
		if (ritmo2 == null ? _cast.ritmo2 != ritmo2 : !ritmo2.equals( _cast.ritmo2 )) {
			return false;
		}
		...
		if (conducav2 == null ? _cast.conducav2 != conducav2 : !conducav2.equals( _cast.conducav2 )) {
			return false;
		}
		...
		if (qrs2 == null ? _cast.qrs2 != qrs2 : !qrs2.equals( _cast.qrs2 )) {
			return false;
		}
	...
	public int hashCode()
	{
		...
		if (ritmo2 != null) {
			_hashCode = 29 * _hashCode + ritmo2.hashCode();
		}
		...
		if (conducav2 != null) {
			_hashCode = 29 * _hashCode + conducav2.hashCode();
		}
		...
		if (qrs2 != null) {
			_hashCode = 29 * _hashCode + qrs2.hashCode();
		}
	 ...
	 * Method 'createPk'
	 * 
	 * @return SituacionClinicaProcPk
	 */
	public SituacionClinicaProcPk createPk()
	{
		return new SituacionClinicaProcPk(idsitclin);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.sorin.idea.dto.SituacionClinicaProc: " );
		ret.append( "idsitclin=" + idsitclin );
		ret.append( ", ritmo=" + ritmo );
		ret.append( ", ritmo2=" + ritmo2 );
		ret.append( ", conducav=" + conducav );
		ret.append( ", conducav2=" + conducav2 );
		ret.append( ", qrs=" + qrs );
		ret.append( ", qrs2=" + qrs2 );
	...
	public ArrayList<SintomasSitclinProc> getSintomas() {
		return sintomas;
	}

	public void setSintomas(ArrayList<SintomasSitclinProc> sintomas) {
