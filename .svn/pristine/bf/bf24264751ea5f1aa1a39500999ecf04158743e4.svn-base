...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panNuevoItemPlanGen" >
		<h:panelGrid columns="3" width="100%" columnClasses="alignTop,alignTop,alignTop" id="panMedNuevoItemPlanGen">
			<h:panelGrid>
			...
			<h:panelGrid rendered="false" id="panNuevoItemPlanGenCom">
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.planmedgen.idmedcom }"
						...
						<a4j:support event="onchange" reRender="panNuevoItemPlanGen" ajaxSingle="true" />						
					</h:selectOneMenu>
					<h:selectOneMenu value="#{controlMedicacion.planmedgen.idmedcom }"
						rendered="#{controlMedicacion.planmedgen.medicacionDto.medgenerico.tipomed eq 10}">
