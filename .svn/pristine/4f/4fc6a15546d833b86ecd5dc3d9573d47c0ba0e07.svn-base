...
public interface RcRehaNivelEducativoDao
{
	/** 
	...
	/** 
	 * Returns all rows from the RC_REHA_NIVEL_EDUCATIVO table that match the specified arbitrary SQL statement inner join with RC_REHABILITADOR
	 */
