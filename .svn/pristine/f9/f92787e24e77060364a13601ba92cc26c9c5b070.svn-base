 ...
 */
            ...
            /**
            *  OutInsertarEF bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OutInsertarEF
    ...
    public static class Factory{
        ...
        */
        public static OutInsertarEF parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OutInsertarEF object =
                new OutInsertarEF();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"outInsertarEF".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OutInsertarEF)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
