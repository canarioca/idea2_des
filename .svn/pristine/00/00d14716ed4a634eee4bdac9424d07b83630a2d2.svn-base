 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static Personal parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Personal object =
                new Personal();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Personal".equals(type)){
                                ...
                                return (Personal)com.sorin.idea.integracion.canal.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
