...
public class ArrTestEpiEcg implements Serializable
{
	/** 
	 * This attribute maps to the column IDTEST in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idtest;

	/** 
	 * This attribute maps to the column IDRITMO in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idritmo;

	/** 
	 * This attribute maps to the column IDCONDUCCION in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idconduccion;

	/** 
	 * This attribute maps to the column IDCONDUCCIONNO in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idconduccionno;

	/** 
	 * This attribute maps to the column IDQRS in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idqrs;

	/** 
	 * This attribute maps to the column IDQRSNO in the ARR_TEST_EPI_ECG table.
	 */
	protected Integer idqrsno;

	/** 
	 * This attribute maps to the column MORFOLOGIA in the ARR_TEST_EPI_ECG table.
	 */
	protected String morfologia;

	/** 
	 * This attribute maps to the column COMENTARIOS in the ARR_TEST_EPI_ECG table.
	 */
	protected String comentarios;

	/** 
	 * This attribute maps to the column RR in the ARR_TEST_EPI_ECG table.
	 */
	protected String rr;

	/** 
	 * This attribute maps to the column PR in the ARR_TEST_EPI_ECG table.
	 */
	protected String pr;

	/** 
	 * This attribute maps to the column QRS in the ARR_TEST_EPI_ECG table.
	 */
	protected String qrs;

	/** 
	 * This attribute maps to the column QT in the ARR_TEST_EPI_ECG table.
	 */
	protected String qt;

	/** 
	 * This attribute maps to the column QTC in the ARR_TEST_EPI_ECG table.
	 */
	protected String qtc;

	/**
	 * Method 'ArrTestEpiEcg'
	 * 
	 */
	public ArrTestEpiEcg()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ArrTestEpiEcg)) {
			return false;
		}
		
		final ArrTestEpiEcg _cast = (ArrTestEpiEcg) _other;
	 ...
	 * Method 'createPk'
	 * 
	 * @return ArrTestEpiEcgPk
	 */
	public ArrTestEpiEcgPk createPk()
	{
		return new ArrTestEpiEcgPk(idtest);
	}
	...
	public String toString()
	{
		...
		ret.append( "hvn.apl.jProyecto2011.dto.ArrTestEpiEcg: " );
