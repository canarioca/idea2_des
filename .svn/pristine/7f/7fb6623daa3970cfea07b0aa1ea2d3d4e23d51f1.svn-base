...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="100%" id="planMedicacionGeneralImp">
		<h:panelGrid width="100%">
			<h:panelGrid columns="2" cellpadding="0" cellspacing="0">
				<h:outputLabel value="#{ms.med_gen_title }"
					style="font-weight: bold;" />
				<a4j:commandLink reRender="tablaPlanMedGenImp" rendered="false"
					onclick="javascript:Richfaces.showModalPanel('nuevoItemPlanGenImp');">	
					<h:graphicImage value="/img/iconos/add.png" width="16"
						height="16" style="border:0;" title="#{ms.aniadir }"/>				
				</a4j:commandLink>			
			</h:panelGrid>
			<h:panelGrid style="border-top: solid 1px;border-color: black;"
				id="tablaPlanMedGenImp" width="100%">
				...
				<t:dataTable styleClass="hor-minimalist-b" var="medgen" rendered="#{not empty controlMedicacion.planmedicaciongen }"
					...
					binding="#{controlMedicacion.bindingMedicacionGeneralImp }" id="dataTablePlanMedGenImp" rowIndexVar="rib">
					<t:column width="20%" headerstyleClass="left">
						<h:panelGrid columnClasses="alignTop">								
							<a4j:commandLink reRender="tablaPlanMedGenImp,panMedEditItemPlanGenImp,panEditItemPlanGenImp,editItemPlanGenImp"
								actionListener="#{controlMedicacion.preEditarImp }">		
					...
					<t:column headerstyleClass="left">
						<h:panelGrid columns="2">
							...
							<a4j:commandLink reRender="tablaPlanMedGenImp"
								...
								actionListener="#{controlMedicacion.delItemPlanGenImp }">
		...
		<h:panelGrid width="100%">
			<rich:simpleTogglePanel switchType="client" label="#{ms.insertar }" opened="false">
				<h:panelGrid id="panNuevoItemPlanGenImp" >
					<h:panelGrid columns="2" width="100%" columnClasses="alignTop,alignTop" id="panMedNuevoItemPlanGenImp">
						<h:panelGrid>
							...
							<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">						
								<h:selectOneMenu value="#{controlMedicacion.planmedgen.medicacionDto.medgenerico.tipomed }">
									<f:selectItems value="#{controlMedicacion.tiposmedicacion }" />	
									<a4j:support event="onchange" reRender="panMedNuevoItemPlanGenImp" ajaxSingle="true" />						
								</h:selectOneMenu>
							</h:panelGrid>
							<h:panelGrid>
								<h:panelGrid columnClasses="alignTop" >								
						...
						<h:panelGrid id="panFechasItemPlanMedGenImp" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
							<h:panelGrid>
								...
								<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
									<h:selectOneMenu value="#{controlMedicacion.planmedgen.estado }">
										...
										<f:selectItem itemValue="0" itemLabel="#{ms.med_gen_msg_10 }"/>
										<f:selectItem itemValue="-1" itemLabel="#{ms.med_gen_msg_11 }"/>
										<a4j:support event="onchange" reRender="panMotivosSuspItemPlanGenImp" ajaxSingle="true"/>														
									</h:selectOneMenu>
								</h:panelGrid>
							</h:panelGrid>
							<h:panelGrid>
					...
					<h:panelGrid id="panMotivosSuspItemPlanGenImp">
						...
						<h:panelGrid style="border-top: solid 1px;border-color: black;" rendered="#{controlMedicacion.planmedgen.estado eq 0 }">
							<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.planmedgen.motivosuspension }" id="motivosSuspItemPlanGenImp">
								<f:validateLength maximum="1000" />
							</h:inputTextarea>	
							<h:message for="motivosSuspItemPlanGenImp" style="color:red" />
						</h:panelGrid>
					</h:panelGrid>
					<rich:simpleTogglePanel switchType="client" label="#{ms.med_gen_msg_25 }" opened="false">
						<h:panelGrid>
							<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.planmedgen.comentarios }" id="comentariosItemPlanGenImp">
								<f:validateLength maximum="1000" />
							</h:inputTextarea>	
							<h:message for="comentariosItemPlanGenImp" style="color:red" />
						</h:panelGrid>
					</rich:simpleTogglePanel>
				</h:panelGrid>
				<h:panelGrid columns="2" columnClasses="alignTop,alignTop">
					<h:panelGrid columns="2" columnClasses="alignTop,alignTop">
						<a4j:commandLink actionListener="#{controlMedicacion.addItemPlanGen }"
							reRender="tablaPlanMedGenImp,panNuevoItemPlanGenImp"
	...
	<rich:modalPanel id="nuevoItemPlanGenImp" autosized="true" zindex="500" minWidth="550">
		<f:facet name="header">
		...
		<f:facet name="controls">
			<h:panelGrid columns="3">
				<a4j:commandLink actionListener="#{controlMedicacion.addItemPlanGen }"
					reRender="tablaPlanMedGenImp,panNuevoItemPlanGenImp"
					onclick="javascript:Richfaces.hideModalPanel('nuevoItemPlanGenImp');">
					<h:graphicImage style="border: 0px;" value="/img/iconos/guarda.png"
	...
	<rich:modalPanel id="editItemPlanGenImp" autosized="true" zindex="500" minWidth="550" showWhenRendered="#{controlMedicacion.editableImp}">
		<f:facet name="header">
			<h:panelGrid styleClass="center" border="0" columns="2" width="90%">
		...
		<f:facet name="controls">
			<h:panelGrid columns="3">
				<a4j:commandLink actionListener="#{controlMedicacion.editItemPlanGen }"
					reRender="tablaPlanMedGenImp,panEditItemPlanGenImp,dataTablePlanMedGenImp"
					onclick="javascript:Richfaces.hideModalPanel('editItemPlanGenImp');">
					<h:graphicImage style="border: 0px;" value="/img/iconos/guarda.png"
						width="16px" height="16px" title="Guarda registro"/>
				</a4j:commandLink>
		...
		<h:panelGrid id="paneditmedseg" width="100%">
			<ui:include src="/ventanas/implantes/medicacion/editmedgen.jsp" />
		</h:panelGrid>
	</rich:modalPanel>
