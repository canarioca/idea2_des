				...
				<rich:panel
					...
					<h:panelGrid width="90%" columnClasses="centerTop">		
						<rich:tabPanel contentClass="estiloFondo" switchType="client" id="tabmaterial">						
							<rich:tab label="#{ms.mat_tab_gen_title }" rendered="#{controlPacientes.booleanCardioversiónElectrica == true or 
							...
							<rich:tab label="#{ms.mat_tab_ele_title }" rendered="#{controlPacientes.booleanCardioversiónElectrica == true or 
																		             controlPacientes.booleanPrimoImplante == true or 
																		             controlPacientes.booleanReintervencion == true or 
																		             controlPacientes.booleanRecambioDispositivo == true or 
																		             controlPacientes.booleanUpgradeDispositivo == true or 
							...
							<rich:tab label="#{ms.mat_tab_cat_title }" rendered="#{controlPacientes.booleanEEF == true}">
								<h:panelGrid id="matcat" width="100%">
									<a4j:include viewId="/ventanas/administracion/material/cateter.jsp" />
								</h:panelGrid>
							</rich:tab>
							<rich:tab label="#{ms.mat_tab_regev_title }" rendered="#{controlPacientes.booleanRegistradorEventos == true or controlPacientes.booleanRegistradorEventosExterno == true}">
