									...
									<rich:simpleTogglePanel switchType="client" label="#{ms.citas_agenda_huecos_msg_2 }" opened="false" rendered="#{controlCitas.agenda.gestionhuecos eq true }">
										...
										<h:panelGrid style="border-top: solid 1px;border-color: black;" columns="2">
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_EEF}"
												rendered="#{loginForm.accmods.eef eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_eef } (#{controlCitas.HUECO_EEF * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.eef eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_CV}"
												rendered="#{loginForm.accmods.cv eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_cv } (#{controlCitas.HUECO_CV * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.cv eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_MESA}"
												rendered="#{loginForm.accmods.mesa eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_mesa } (#{controlCitas.HUECO_MESA * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.mesa eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_REG}"
												rendered="#{loginForm.accmods.registrador eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_regev } (#{controlCitas.HUECO_REG * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.registrador eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_REGEVEXT}"
												rendered="#{loginForm.accmods.registrador eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_elr } (#{controlCitas.HUECO_REGEVEXT * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.registrador eq 1 }"/>	
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_HOLTER_24H}"
												rendered="#{loginForm.accmods.holter eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_holter } (#{controlCitas.HUECO_HOLTER_24H * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.holter eq 1 }"/>											
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_ATP}"
												rendered="#{loginForm.accmods.test eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_atp } (#{controlCitas.HUECO_ATP * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.test eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_EPI}"
												rendered="#{loginForm.accmods.test eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_epi } (#{controlCitas.HUECO_EPI * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.test eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_FLE}"
												rendered="#{loginForm.accmods.test eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_fle } (#{controlCitas.HUECO_FLE * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.test eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_IMP_MPS}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_imp_mps } (#{controlCitas.HUECO_IMP_MPS * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_IMP_DAI}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_imp_dai } (#{controlCitas.HUECO_IMP_DAI * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_IMP_CRTP}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_imp_crtp } (#{controlCitas.HUECO_IMP_CRTP * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_IMP_CRTD}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_imp_crtd } (#{controlCitas.HUECO_IMP_CRTD * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_SEG_MPS}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_seg_mps } (#{controlCitas.HUECO_SEG_MPS * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_SEG_DAI}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_seg_dai } (#{controlCitas.HUECO_SEG_DAI * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_SEG_CRTP}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_seg_crtp } (#{controlCitas.HUECO_SEG_CRTP * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_SEG_CRTD}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_seg_crtd } (#{controlCitas.HUECO_SEG_CRTD * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_EXPLANTE}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_exp } (#{controlCitas.HUECO_EXPLANTE * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_REINTERVENCION}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_reint } (#{controlCitas.HUECO_REINTERVENCION * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_REC_GEN}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_rec_gen } (#{controlCitas.HUECO_REC_GEN * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_REC_ELE}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_rec_ele } (#{controlCitas.HUECO_REC_ELE * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
											<rich:inputNumberSpinner minValue="1" maxValue="10" step="1" value="#{controlCitas.HUECO_SEG_CLIN}"
												rendered="#{loginForm.accmods.implante eq 1 }"/>
											<h:outputLabel value="#{ms.proc_label_seg_clin } (#{controlCitas.HUECO_SEG_CLIN * controlCitas.TAM_HUECO} min)" rendered="#{loginForm.accmods.implante eq 1 }"/>
										</h:panelGrid>
										<h:panelGrid columns="2">
											<a4j:commandLink reRender="panCitas" 
												actionListener="#{controlCitas.actualizaValoresProperties }"
