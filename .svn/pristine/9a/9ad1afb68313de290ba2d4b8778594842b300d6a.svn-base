...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid>
		...
		<h:panelGrid columns="2" width="90%" columnClasses="left,left">
			...
			<h:outputLabel value="#{ms.holter24h_tab2_col_recom }" style="font-weight: bold;" />
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlHolter.holter.comentariosCol }" rows="4" cols="90" id="comentariosHolterColoc">
					<f:validateLength maximum="2000" />
				</h:inputTextarea>
				<h:message for="comentariosHolterColoc" style="color:red" />	
			</h:panelGrid>
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlHolter.holter.recomendaciones }" rows="4" cols="90" id="comentariosHolterRec">
					<f:validateLength maximum="2000" />
				</h:inputTextarea>
