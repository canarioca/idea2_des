...
(function VKI_buildKeyboardInputs() {
  ...
  this.VKI_imageURI = "/idea/img/genericos/keyboard.png";  // If empty string, use imageless mode
  ...
  this.VKI_i18n = {
    ...
    '02': "Seleccionar teclado",
    '03': "Teclas especiales",
    '04': "Encendido",
    '05': "Apagado",
    ...
    '08': "Limpiar el campo",
    '09': "Versi\u00f3n",
    '10': "Disminuir tama\u00f1o teclado",
    '11': "Aumentar tama\u00f1o teclado"
  };
  ...
  this.VKI_layout['Espa\u00f1ol'] = {
    'name': "Spanish", 'keys': [
      [["\u00ba", "\u00aa", "\\"], ["1", "!", "|"], ["2", '"', "@"], ["3", "'", "#"], ["4", "$", "~"], ["5", "%", "\u20ac"], ["6", "&", "\u00ac"], ["7", "/"], ["8", "("], ["9", ")"], ["0", "="], ["'", "?"], ["\u00a1", "\u00bf"], ["Del", "Del"]],
      [["Tab", "Tab"], ["q", "Q"], ["w", "W"], ["e", "E"], ["r", "R"], ["t", "T"], ["y", "Y"], ["u", "U"], ["i", "I"], ["o", "O"], ["p", "P"], ["`", "^", "["], ["+", "*", "]"], ["\u00e7", "\u00c7", "}"]],
      [["Caps", "Caps"], ["a", "A"], ["s", "S"], ["d", "D"], ["f", "F"], ["g", "G"], ["h", "H"], ["j", "J"], ["k", "K"], ["l", "L"], ["\u00f1", "\u00d1"], ["\u00b4", "\u00a8", "{"], ["Intro", "Intro"]],
  ...
  if (!this.VKI_layout[this.VKI_kt])
    return alert('No existe el teclado "' + this.VKI_kt + '"');
      ...
      for (var y = 0; y < tds.length; y++) {
        ...
        switch (lkey[1]) {
          ...
          case "Caps":
            ...
            break;
          case "Tab": case "Intro": case "Del": break;
          default:
            if (type) {
