	...
	<ui:define name="contenido">
		<h:form id="indiceFormt" 
			...
			<h:panelGrid cellpadding="0" cellspacing="0" columns="1" width="100%">
				...
				<rich:panel id="panelLogint" 
					style="width: 500px;">
					<f:facet name="header">
						<h:outputText value="#{ms.login_saludo }"/>
					</f:facet>
					
					<h:outputLabel value="#{ms.login_caducado }" style="color:red;" />
				
					<h:panelGrid columns="2">
						<h:outputLabel for="Usuariot" value="#{ms.login_usuario }" />
						<h:inputText id="Usuariot"
						...
						<h:outputLabel for="passt" value="#{ms.login_pw }" />
						<h:inputSecret id="passt" value="#{loginForm.pass }" size="40"
					...
					<h:panelGrid columns="2" align="center">
						<h:commandButton immediate="false" id="botonLogint" value="#{ms.acceder }"
							styleClass="boton" title="#{ms.acceder }"
							action="#{loginForm.acnAutenticarUsuario}"
							onclick="javascript:Richfaces.showModalPanel('accesot')"/>
						<h:commandButton id="idBotonLimpiat" title="#{ms.limpiar }"
			...
			<rich:modalPanel id="accesot" minHeight="80" minWidth="150"
			...
			<script type="text/javascript">
				document.getElementById('indiceFormt:Usuariot').focus();
			</script>
		</h:form>
	</ui:define>
