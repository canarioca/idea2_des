...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="100%" id="panComplicacionesPacienteImpEv">
		<h:panelGrid width="100%">
			<h:outputLabel value="#{ms.compli_proc_imp_post_title }" style="font-weight: bold;"/>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="tablaComplicacionesImpEvProc" width="100%">
				<h:outputLabel value="#{ms.compli_msg_imp_post}" rendered="#{empty controlImplantes.listacomppost }"/>
				<t:dataTable styleClass="hor-minimalist-b" var="comp" rendered="#{not empty controlImplantes.listacomppost }"
					width="100%" value="#{controlImplantes.listacomppost }"
					binding="#{controlImplantes.bindingComplicacionesImpProcPost }" id="dataTableComplicacionesImpEvProc" rowIndexVar="rib">
					<t:column width="5%" headerstyleClass="left">
						<h:panelGrid columnClasses="alignTop">								
							<a4j:commandLink reRender="tablaComplicacionesImpEvProc,panEditItemComplicacionesPacImpEv,editItemComplicacionesPacImpEv"
								actionListener="#{controlImplantes.preEditarImpProcEv }">		
					...
					<t:column headerstyleClass="left">
						<h:panelGrid columns="2">
							<a4j:commandLink reRender="tablaComplicacionesImpEvProc,dataTableComplicacionesImpEvProc,cabecerapaciente,panelContenidoGlobal"
								onclick="if (!confirm('#{ms.compli_msg_warn_borra}')) return false;javascript:Richfaces.showModalPanel('buscando');"
								oncomplete="javascript:Richfaces.hideModalPanel('buscando');"
								actionListener="#{controlImplantes.delItemComplicacionEv }">
		...
		<h:panelGrid width="100%">
			<rich:simpleTogglePanel switchType="client" label="#{ms.insertar }" opened="false">
				<h:panelGrid id="panNuevaComplicacionPacImpEv" width="100%" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
					...
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panNuevaComPacCompliImpEv">
						<h:selectOneMenu value="#{controlImplantes.compacpost.complicacion }">
							<f:selectItems value="#{controlComplicaciones.complicacionesImpl }" />
							<a4j:support event="onchange" reRender="panNuevaComPacCompliImpEv" ajaxSingle="true" />						
						</h:selectOneMenu>
						<h:selectOneMenu value="#{controlImplantes.compacpost.complicacion1 }" 
							rendered="#{controlImplantes.compacpost.complicacion eq  controlComplicaciones.idarritmias}">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
							<f:selectItem itemValue="1" itemLabel="#{ms.compli_compl_arritmias_1 }"/>
							<f:selectItem itemValue="2" itemLabel="#{ms.compli_compl_arritmias_2 }"/>
							<f:selectItem itemValue="3" itemLabel="#{ms.compli_compl_arritmias_3 }"/>
						...
						<h:selectOneMenu value="#{controlImplantes.compacpost.complicacion1 }" 
							rendered="#{controlImplantes.compacpost.complicacion eq  controlComplicaciones.idhematoma}">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
							<f:selectItem itemValue="1" itemLabel="#{ms.compli_compl_hematoma_1 }"/>
							<f:selectItem itemValue="2" itemLabel="#{ms.compli_compl_hematoma_2 }"/>
							<f:selectItem itemValue="3" itemLabel="#{ms.compli_compl_hematoma_3 }"/>
						</h:selectOneMenu>
						<h:inputText value="#{controlImplantes.compacpost.complicacionOtra }" 
							rendered="#{controlImplantes.compacpost.complicacion eq  controlComplicaciones.idcompotra}"/>
					</h:panelGrid>
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
						<h:selectOneMenu value="#{controlImplantes.compacpost.tipo }">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
							<f:selectItem itemValue="2" itemLabel="#{ms.compli_tipo_2 }"/>
							<f:selectItem itemValue="3" itemLabel="#{ms.compli_tipo_3 }"/>
						</h:selectOneMenu>
					...
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
						<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
							...
							value="#{controlImplantes.compacpost.fechaini }" />
					</h:panelGrid>
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
						<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
							showWeeksBar="false" direction="bottom-left" 
							value="#{controlImplantes.compacpost.fechafin }" />
					</h:panelGrid>
					...
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
						<h:selectOneMenu value="#{controlImplantes.compacpost.resuelta }">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
					...
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panNuevaComPacTratImpEv">								
						<h:selectOneMenu value="#{controlImplantes.compacpost.tratamiento }">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
							<f:selectItem itemValue="0" itemLabel="#{ms.compli_tratamiento_0 }"/>
							<f:selectItem itemValue="1" itemLabel="#{ms.compli_tratamiento_1 }"/>
							<a4j:support event="onchange" reRender="panNuevaComPacTratImpEv" ajaxSingle="true" />
						</h:selectOneMenu>
						<h:inputText value="#{controlImplantes.compacpost.tratamientoDescr }" 
							rendered="#{controlImplantes.compacpost.tratamiento eq 1}"/>
					</h:panelGrid>
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
						<h:selectOneMenu value="#{controlImplantes.compacpost.ingreso }">
							<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
					...
					<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
						<h:inputTextarea cols="40" rows="4" value="#{controlImplantes.compacpost.descripcion }" id="descNuevaComPacImpEv">
							<f:validateLength maximum="1000" />
						</h:inputTextarea>	
						<h:message for="descNuevaComPacImpEv" style="color:red" />
					</h:panelGrid>
				</h:panelGrid>
				<h:panelGrid>
				...
				<h:panelGrid columns="2" columnClasses="alignTop,alignTop">
					<h:panelGrid columns="2" columnClasses="alignTop,alignTop">
						<a4j:commandLink actionListener="#{controlImplantes.guardaComplicacionPost }"
							reRender="tablaComplicacionesImpEvProc,dataTableComplicacionesImpEvProc,panNuevaComplicacionPacImpEv,cabecerapaciente,panelContenidoGlobal"
					...
					<h:panelGrid columns="2" columnClasses="alignTop,alignTop">
						<a4j:commandLink actionListener="#{controlImplantes.limpiarComp }"
							reRender="tablaComplicacionesImpEvProc,panNuevaComplicacionPacImpEv"
							onclick="javascript:Richfaces.showModalPanel('buscando');"
							oncomplete="javascript:Richfaces.hideModalPanel('buscando');">
	...
	<rich:modalPanel id="editItemComplicacionesPacImpEv" autosized="true" zindex="500" minWidth="550" showWhenRendered="#{controlImplantes.editableImpEvProc}">
		<f:facet name="header">
		...
		<f:facet name="controls">
			<h:panelGrid columns="3">
				<a4j:commandLink actionListener="#{controlImplantes.actualizaItemComplicacionPost }"
					reRender="dataTableComplicacionesImpEvProc,cabecerapaciente,tablaComplicacionesImpEvProc,panelContenidoGlobal"
					onclick="javascript:Richfaces.hideModalPanel('editItemComplicacionesPacImpEv');">
					<h:graphicImage style="border: 0px;" value="/img/iconos/guarda.png"
						width="16px" height="16px" title="#{ms.guardar }"/>
				</a4j:commandLink>
				<a4j:commandLink actionListener="#{controlImplantes.cancelarItemComplicacion }"
					reRender="panEditItemComplicacionesPacImpEv,tablaComplicacionesImpEvProc,dataTableComplicacionesImpEvProc"
					onclick="javascript:Richfaces.hideModalPanel('editItemComplicacionesPacImpEv');">
		...
		<h:panelGrid id="paneditcompacimpev" width="100%">
			<ui:include src="/ventanas/implantes/complicaciones/editcomplicacionEv.jsp" />
		</h:panelGrid>
	</rich:modalPanel>
