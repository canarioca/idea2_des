...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panEditItemComplicacionesPacImp" >
		<h:panelGrid id="panEditComplicacionPacImp" width="100%" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacCompliImp">
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.complicacion }">
					<f:selectItems value="#{controlComplicaciones.complicacionesImpl }" />
					<a4j:support event="onchange" reRender="panEditComPacCompliImp" ajaxSingle="true" />						
				</h:selectOneMenu>
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.complicacion1 }" 
					rendered="#{controlImplantes.currentItemComp.complicacion eq  controlComplicaciones.idarritmias}">
				...
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.complicacion1 }" 
					rendered="#{controlImplantes.currentItemComp.complicacion eq controlComplicaciones.idhematoma}">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
				...
				<h:inputText value="#{controlImplantes.currentItemComp.complicacionOtra }" 
					rendered="#{controlImplantes.currentItemComp.complicacion eq controlComplicaciones.idcompotra}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.tipo }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					...
					value="#{controlImplantes.currentItemComp.fechaini }" />
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					showWeeksBar="false" direction="bottom-left" 
					value="#{controlImplantes.currentItemComp.fechafin }" />
			</h:panelGrid>
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.resuelta }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacTratImp">								
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.tratamiento }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
					<f:selectItem itemValue="0" itemLabel="#{ms.compli_tratamiento_0 }"/>
					<f:selectItem itemValue="1" itemLabel="#{ms.compli_tratamiento_1 }"/>
					<a4j:support event="onchange" reRender="panEditComPacTratImp" ajaxSingle="true" />
				</h:selectOneMenu>
				<h:inputText value="#{controlImplantes.currentItemComp.tratamientoDescr }" 
					rendered="#{controlImplantes.currentItemComp.tratamiento eq 1}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlImplantes.currentItemComp.ingreso }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea cols="40" rows="4" value="#{controlImplantes.currentItemComp.descripcion }" id="descEditComPacImp">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="descEditComPacImp" style="color:red" />
			</h:panelGrid>
		</h:panelGrid>
	</h:panelGrid>
</ui:composition>