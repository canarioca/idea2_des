...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="100%">
		...
		<h:panelGrid style="border-top: solid 1px;border-color: black;"
			...
			<t:dataTable styleClass="hor-minimalist-b" var="lineaEst" width="100%"
				...
				<t:column width="23%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaEst.conduc }"
				...
				<t:column width="23%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaEst.bloqueo }"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;">
				...
				<t:column width="23%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaEst.nviel }"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;">
				...
				<t:column width="5%" headerstyleClass="left">
					...
					<h:inputText value="#{lineaEst.msvalor }" maxlength="5"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;"/>
				</t:column>
	...
	<h:panelGrid columns="2" cellpadding="0" cellspacing="0" width="100%"
		...
		<h:panelGrid style="border-top: solid 1px;border-color: black;"
			...
			<t:dataTable styleClass="hor-minimalist-b" var="lineaAV" width="100%"
				...
				<t:column width="60%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaAV.prueba }"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;">
				...
				<t:column width="35%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaAV.resultado }"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;">
