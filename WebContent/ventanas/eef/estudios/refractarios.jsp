...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="90%">
		...
		<h:panelGrid style="border-top: solid 1px;border-color: black;"
			...
			<t:dataTable styleClass="hor-minimalist-b" var="lineaPR" width="100%"
				...
				<t:column width="15%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaPR.idtipo }"
				...
				<t:column width="15%" headerstyleClass="left">
					...
					<h:selectOneMenu value="#{lineaPR.idfarmaco }"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;">
				...
				<t:column width="15%" headerstyleClass="left">
					...
					<h:inputText size="5" value="#{lineaPR.ids1 }" maxlength="20"/>
				</t:column>
				<t:column width="15%" headerstyleClass="left">
					<f:facet name="header">
						<h:outputText value="#{ms.eef_tab_pref_valor }" />
					</f:facet>
					<h:inputText value="#{lineaPR.ref }" maxlength="20"
						style="font-size: 10px;font-family: Lucida Grande, Lucida Sans, Arial, sans-serif;"/>
				</t:column>
