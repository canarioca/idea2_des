...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="tablaPacientesBduPrt" width="100%">
		<h:outputText rendered="#{empty controlEef.listaprot}"
		...
		<t:dataTable styleClass="hor-minimalist-b" var="prot" width="90%"
			binding="#{controlEef.bindingProt}" id="tablaprotocolospat" rows="13"
			preserveDataModel="true" value="#{controlEef.listaprot}">
			<t:column id="vinculoPrt">
				<f:facet name="header">
					<h:outputText value="" />
				</f:facet>
				<a4j:commandLink reRender="panHolter,panicoholter"
					actionListener="#{controlEef.vincularProtocolo}"
			...
			<t:column id="tipoPrt">
				...
				<h:selectOneMenu value="#{prot.tipo }" disabled="true">
					<f:selectItems value="#{controlEef.tipos}" />							
				</h:selectOneMenu>
			</t:column>
			<t:column id="verPrt">
				<f:facet name="header">
				...
				<a4j:commandLink actionListener="#{controlEef.irProtocolo}"
