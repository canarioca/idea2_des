...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="100%" columnClasses="alignTop" 
		...
		<h:panelGrid width="50%">
			<h:outputLabel value="#{ms.export_datos_tab_mesa_filtro_title }" style="color: red;font-size: 14px;font-weight: bold;"/>
				...
				<h:panelGrid style="border-top: solid 1px;border-color: black;" width="80%">
					<h:panelGrid columns="4" cellspacing="0">
						...
						<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
								...
								value="#{controlConsultas.fechaini }">
						</rich:calendar>
						<h:outputLabel value="#{ms.export_datos_fecha_hasta }"/>
						<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
								showWeeksBar="false" direction="bottom-left"
								value="#{controlConsultas.fechafin }">
						</rich:calendar>
					</h:panelGrid>
				</h:panelGrid>				
			</h:panelGrid>
			<h:panelGrid>
				<h:outputLabel value="#{ms.mesa_tab3_res_title }" style="font-weight: bold;" rendered="true"/>				
				<h:panelGrid style="border-top: solid 1px;border-color: black;" width="80%" rendered="true">
					<h:selectOneMenu value="#{controlConsultas.filtromesares }">
					 	<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="0" />
						<f:selectItem itemLabel="#{ms.mesa_tab3_res_op1 }" itemValue="1" />
						<f:selectItem itemLabel="#{ms.mesa_tab3_res_op0 }" itemValue="2" />
					</h:selectOneMenu>
				</h:panelGrid>
			</h:panelGrid>
		</h:panelGrid>
		...
		<h:panelGrid columns="2">
			<t:commandLink value="#{ms.export_datos_tab_mesa_gen_msg }" actionListener="#{controlConsultas.generaEstadisticasMesa}"
				target="_blank" style="font-size: 14px;font-weight: bold;" title="#{ms.export_datos_generar_consulta }"/>
			<t:commandLink actionListener="#{controlConsultas.generaEstadisticasMesa}" target="_blank" title="#{ms.export_datos_generar_consulta }">
