...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="tablaPacientesBduPrt" width="100%">
		<h:outputText rendered="#{empty controlRegistrador.listaprot}"
		...
		<t:dataTable styleClass="hor-minimalist-b" var="prot" width="90%"
			binding="#{controlRegistrador.bindingProt}" id="tablaprotocolospat" rows="13"
			preserveDataModel="true" value="#{controlRegistrador.listaprot}">
			<t:column id="vinculoPrt">
				<f:facet name="header">
					<h:outputText value="" />
				</f:facet>
				<a4j:commandLink reRender="panRegistrador,panicoregs"
					actionListener="#{controlRegistrador.vincularProtocolo}"
			...
			<t:column id="fechaIniPrt">
				...
				<a4j:commandLink value="#{prot.fechacreacion}" reRender="panRegistrador,panicoregs"
					actionListener="#{controlRegistrador.vincularProtocolo}"
					onclick="javascript:Richfaces.showModalPanel('buscando');javascript:Richfaces.hideModalPanel('protocolos');"
					oncomplete="javascript:Richfaces.hideModalPanel('buscando');" />
			</t:column>
			<t:column id="tipoPrt">
				...
				<h:selectOneMenu value="#{prot.tipo }" disabled="true">
					<f:selectItems value="#{controlRegistrador.tipos}" />							
				</h:selectOneMenu>
			</t:column>
			<t:column id="verPrt">
				<f:facet name="header">
				...
				<a4j:commandLink actionListener="#{controlRegistrador.irProtocolo}"
