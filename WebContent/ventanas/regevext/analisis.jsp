...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid width="90%" columns="6" columnClasses="left,left">
		<h:panelGrid>
		...
		<h:panelGrid>
			<h:outputLabel value="#{ms.listadoPlantillasCreadas}" style="font-weight: bold;" />
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:selectOneMenu onclick="showOnMap(this)" style="width:200px;" layout="spread" id="idSelectedPlantilla" value="#{controlRegEvExt.selectedPlantilla}">
	 				 <f:selectItems value="#{controlRegEvExt.listaPlantillas}" />
	 				 <a4j:support event="onchange" ajaxSingle="false" reRender="comentariosRegEvExtRet" actionListener="#{controlRegEvExt.cambiarPlantilla}" />
				</h:selectOneMenu>   
			</h:panelGrid>
		</h:panelGrid>
	</h:panelGrid>
		...
		<h:panelGrid>
			...
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlRegEvExt.regevext.comentariosAna}" rows="4" cols="90" id="comentariosHolterRec">
					<f:validateLength maximum="2000" />
				</h:inputTextarea>
				<h:message for="comentariosHolterRec" style="color:red" />	
			</h:panelGrid>
		</h:panelGrid>
		
		<h:panelGrid>
			<h:outputLabel value="#{ms.holter24h_tab2_col_conclu }" style="font-weight: bold;" />
			<h:panelGrid style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea value="#{controlRegEvExt.regevext.recomendaciones}" rows="4" cols="205" id="comentariosRegEvExtRet">
					<f:validateLength maximum="2000" />
				</h:inputTextarea>
