			...
			<rich:modalPanel id="procedimiento" autosized="true" minHeight="50" minWidth="200" zindex="2000">
				...
				<h:panelGrid>
					...
					<h:panelGrid columns="2" >
						...
						<a4j:commandLink action="irRehabilitacionCardiaca" value="#{ms.pat_procs_modal_msg_8 }" 
							actionListener="#{controlRehabilitacionCardiaca.cargaRehabilitacionCardiacaDesdeBarraTemporal}" rendered="#{controlPacientes.tipoprocedimiento eq 1094 }"/>
