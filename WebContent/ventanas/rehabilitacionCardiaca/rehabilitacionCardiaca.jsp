					...
					<f:facet name="header">
                     	<h:panelGrid columns="7" width="65%" columnClasses="left,right"
							...
							<a4j:commandLink style="text-align: right;"
								...
								actionListener="#{controlRehabilitacionCardiaca.guardarRehabilitacionCardiaca}" >
								<h:graphicImage url="/img/iconos/guardar.png" style="border:0px;" title="#{ms.guardar}" />
							</a4j:commandLink>
							<a4j:commandLink style="text-align: right;" reRender="panelRehabilitacionCardiaca"
									onclick="if (!confirm('#{ms.warn_borra}')) return false;javascript:Richfaces.showModalPanel('buscando');"
									oncomplete="javascript:Richfaces.hideModalPanel('buscando');"
									actionListener="#{controlRehabilitacionCardiaca.eliminar }" action="menuprincipal"
									rendered="#{controlRehabilitacionCardiaca.rehabilitacionCardiacaDTO.idProcedimiento ne null and loginForm.acceso.privs.borrado eq 1}">
									<h:graphicImage url="/img/iconos/borra.png" style="border:0px;" width="24" height="24"
										title="#{ms.eliminar }" />
							</a4j:commandLink>
							<h:commandLink actionListener="#{controlRehabilitacionCardiaca.imprimeInforme}"
								rendered="#{controlRehabilitacionCardiaca.rehabilitacionCardiacaDTO.idProcedimiento ne null }" target="_blank">
