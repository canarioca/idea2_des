...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panEditItemPlanGenSeg" >
		<h:panelGrid columns="3" width="100%" columnClasses="alignTop,alignTop,alignTop" id="panMedEditItemPlanGenSeg">
			<h:panelGrid>
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
					<r:comboBox enableManualInput="true" defaultLabel="Escriba nombre de medicamento" width="220"
						...
						<a4j:support event="onchange" reRender="panMedEditItemPlanGenSeg" ajaxSingle="true"
					...
					<h:selectOneMenu value="#{controlMedicacion.currentItem.medicacionDto.medgenerico.tipomed }">
						...
						<a4j:support event="onchange" reRender="panEditMedGenComponentesSeg" ajaxSingle="true" />						
					</h:selectOneMenu>
				</h:panelGrid>
				<h:panelGrid>
					<h:panelGrid columnClasses="alignTop" id="panEditMedGenComponentesSeg">								
			...
			<h:panelGrid rendered="false" id="panEditItemPlanGenSegCom">
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.currentItem.idmedcom }"
						...
						<a4j:support event="onchange" reRender="panEditItemPlanGenSeg" ajaxSingle="true" />						
					</h:selectOneMenu>
					<h:selectOneMenu value="#{controlMedicacion.currentItem.idmedcom }"
		...
		<h:panelGrid id="panEditFechasItemPlanMedGenSeg" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
			<h:panelGrid>
				...
				<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
					<h:selectOneMenu value="#{controlMedicacion.currentItem.estado }">
						...
						<a4j:support event="onchange" reRender="panEditMotivosSuspItemPlanGenSeg" ajaxSingle="true"/>														
					</h:selectOneMenu>
				</h:panelGrid>
			</h:panelGrid>
			<h:panelGrid>
		...
		<h:panelGrid id="panEditMotivosSuspItemPlanGenSeg">
			...
			<h:panelGrid style="border-top: solid 1px;border-color: black;" rendered="#{controlMedicacion.currentItem.estado eq 0 }">
				<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.currentItem.motivosuspension }" id="motivosEditSuspItemPlanGenSeg">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="motivosEditSuspItemPlanGenSeg" style="color:red" />
			</h:panelGrid>
		</h:panelGrid>
		<rich:simpleTogglePanel switchType="client" label="#{ms.med_gen_msg_25 }" opened="false">
			<h:panelGrid>
				<h:inputTextarea cols="80" rows="8" value="#{controlMedicacion.currentItem.comentarios }" id="comentariosEditItemPlanGenSeg">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="comentariosEditItemPlanGenSeg" style="color:red" />
			</h:panelGrid>
		</rich:simpleTogglePanel>
	</h:panelGrid>
</ui:composition>