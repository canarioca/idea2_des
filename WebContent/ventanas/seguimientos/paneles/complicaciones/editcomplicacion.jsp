...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:panelGrid id="panEditItemComplicacionesPacSeg" >
		<h:panelGrid id="panEditComplicacionPacSeg" width="100%" columns="4" columnClasses="alignTop,alignTop,alignTop,alignTop">
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacCompliSeg">
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.complicacion }">
					<f:selectItems value="#{controlComplicaciones.complicacionesImpl }" />
					<a4j:support event="onchange" reRender="panEditComPacCompliSeg" ajaxSingle="true" />						
				</h:selectOneMenu>
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.complicacion1 }" 
					rendered="#{controlSeguimientos.currentItemComp.complicacion eq  controlComplicaciones.idarritmias}">
				...
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.complicacion1 }" 
					rendered="#{controlSeguimientos.currentItemComp.complicacion eq controlComplicaciones.idhematoma}">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
				...
				<h:inputText value="#{controlSeguimientos.currentItemComp.complicacionOtra }" 
					rendered="#{controlSeguimientos.currentItemComp.complicacion eq controlComplicaciones.idcompotra}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.tipo }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					...
					value="#{controlSeguimientos.currentItemComp.fechaini }" />
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<rich:calendar datePattern="dd/MM/yyyy" inputSize="12"
					showWeeksBar="false" direction="bottom-left" 
					value="#{controlSeguimientos.currentItemComp.fechafin }" />
			</h:panelGrid>
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.resuelta }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;" id="panEditComPacTratSeg">								
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.tratamiento }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
					<f:selectItem itemValue="0" itemLabel="#{ms.compli_tratamiento_0 }"/>
					<f:selectItem itemValue="1" itemLabel="#{ms.compli_tratamiento_1 }"/>
					<a4j:support event="onchange" reRender="panEditComPacTratSeg" ajaxSingle="true" />
				</h:selectOneMenu>
				<h:inputText value="#{controlSeguimientos.currentItemComp.tratamientoDescr }" 
					rendered="#{controlSeguimientos.currentItemComp.tratamiento eq 1}"/>
			</h:panelGrid>
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">								
				<h:selectOneMenu value="#{controlSeguimientos.currentItemComp.ingreso }">
					<f:selectItem itemLabel="#{ms.seleccione_opcion }" itemValue="-1" />
			...
			<h:panelGrid columnClasses="alignTop" style="border-top: solid 1px;border-color: black;">
				<h:inputTextarea cols="40" rows="4" value="#{controlSeguimientos.currentItemComp.descripcion }" id="descEditComPacSeg">
					<f:validateLength maximum="1000" />
				</h:inputTextarea>	
				<h:message for="descEditComPacSeg" style="color:red" />
			</h:panelGrid>
		</h:panelGrid>
	</h:panelGrid>
</ui:composition>